...
if __name__ == "__main__":
    ...
    if train:
        ...
        for epoch in range(1, n_epochs + 1):
            ...
            if epoch % 100 == 0:
                ...
                plt.savefig("/home/gjc7gx/CovNNet/Figures/DMOloss_curve.png", dpi=160)
    ...
    _ = plot_one_simulation_with_bands_and_corr_blocks(
            ...
            ci_sigma=2.0,
            savepath="/home/gjc7gx/CovNNet/Figures/DMO_one_sim_with_bands.png",
