...
if __name__ == "__main__":
    ...
    MODEL_NAME = f"STO_10_700_10_700"
    ...
    diag_eps = 1e-6
    cov_hc       = 700    # hidden width
    cov_nl       = 10     # hidden layers
    mean_hc       = 700   # hidden width
    mean_nl       = 10     # hidden layers
    wd       = 1e-5
    n_epochs = 35000
    ...
    if train:
        ...
        for epoch in range(1, n_epochs + 1):
            ...
            if epoch % 100 == 0:
                ...
                plt.savefig("/home/gjc7gx/CovNNet/Figures/STOloss_curve.png", dpi=160)
    ...
    _ = plot_one_simulation_with_bands_and_corr_blocks(
            ...
            ci_sigma=2.0,
            savepath="/home/gjc7gx/CovNNet/Figures/STO_one_sim_with_bands.png",
